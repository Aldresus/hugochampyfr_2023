...
export default function IconJetbrains(props: IconProps) {
  return (
    <svg {...props} viewBox="0 0 128 128">
      <path d="M48.6 61.4c0-.5-.3-.8-1.1-.8h-1.4v1.5h1.4c.7 0 1.1-.2 1.1-.7zm13-.7h1.8l-.9-2.2zm-13.3-2.4c0-.5-.3-.7-1-.7h-1.1V59h1.1c.6.1 1-.2 1-.7zm6.7-.5h-1.2v1.9H55c.7 0 1.2-.4 1.2-1s-.5-.9-1.2-.9z"></path>
